<?php
    ...
    class AdminActionController
    {
        ...
        public static function updateUserInformations($userid,$rank,$username,$email,$banned) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function updateUserPersonalInformations($userid,$postcode,$city,$street,$housenumber,$phone,$firstname,$lastname) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function updateShopTheme($theme) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function updateShopLanguage($language) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function modifyPhrase($id,$language,$phrase,$translated) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function manageCategory($maincategory,$selectedcategory) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function createNewCategory($name,$shortname) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function createNewCoupon($singleuse,$code,$discount,$availablefrom,$availableto) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function modifyOrderState($id,$orderstate) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function createNewRank($name) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function switchAddon($id,$enabled) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function checkForAddons() {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function checkForThemes() {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
        ...
        public static function updateSMTP($smtp_host,$smtp_user,$smtp_pass) {
            DatabaseConnection::getInstance();
            $pdo = DatabaseConnection::$connection;
